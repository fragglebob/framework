...
class DatabaseEloquentBelongsToManyTest extends PHPUnit\Framework\TestCase {
	...
	{
		$relation = $this->getMockBuilder('Illuminate\Database\Eloquent\Relations\BelongsToMany')->setMethods(array('touchIfTouching'))->setConstructorArgs($this->getRelationArguments())->getMock();
	...
	{
		$relation = $this->getMockBuilder('Illuminate\Database\Eloquent\Relations\BelongsToMany')->setMethods(array('attach'))->setConstructorArgs($this->getRelationArguments())->getMock();
	...
	{
		$relation = $this->getMockBuilder('Illuminate\Database\Eloquent\Relations\BelongsToMany')->setMethods(array('attach', 'detach'))->setConstructorArgs($this->getRelationArguments())->getMock();
		$query = m::mock('stdClass');
		$query->shouldReceive('from')->once()->with('user_role')->andReturn($query);
		$query->shouldReceive('where')->once()->with('user_id', 1)->andReturn($query);
		$relation->getQuery()->shouldReceive('getQuery')->andReturn($mockQueryBuilder = m::mock('StdClass'));
	...
	{
		$relation = $this->getMockBuilder('Illuminate\Database\Eloquent\Relations\BelongsToMany')->setMethods(array('attach', 'detach', 'touchIfTouching', 'updateExistingPivot'))->setConstructorArgs($this->getRelationArguments())->getMock();
		$query = m::mock('stdClass');
		$query->shouldReceive('from')->once()->with('user_role')->andReturn($query);
		$query->shouldReceive('where')->once()->with('user_id', 1)->andReturn($query);
		$relation->getQuery()->shouldReceive('getQuery')->andReturn($mockQueryBuilder = m::mock('StdClass'));
	...
	{
		$relation = $this->getMockBuilder('Illuminate\Database\Eloquent\Relations\BelongsToMany')->setMethods(array('touch', 'touchingParent'))->setConstructorArgs($this->getRelationArguments())->getMock();
	...
	{
		$relation = $this->getMockBuilder('Illuminate\Database\Eloquent\Relations\BelongsToMany')->setMethods(array('attach', 'detach', 'touchIfTouching', 'formatSyncList'))->setConstructorArgs($this->getRelationArguments())->getMock();
		$query = m::mock('stdClass');
		$query->shouldReceive('from')->once()->with('user_role')->andReturn($query);
		$query->shouldReceive('where')->once()->with('user_id', 1)->andReturn($query);
		$relation->getQuery()->shouldReceive('getQuery')->andReturn($mockQueryBuilder = m::mock('StdClass'));
