...
class PaginationBootstrapPresenterTest extends PHPUnit\Framework\TestCase {
	...
	{
		$presenter = $this->getMockBuilder('Illuminate\Pagination\BootstrapPresenter')->setMethods(array('getPageRange', 'getPrevious', 'getNext'))->setConstructorArgs(array($paginator = $this->getPaginator()))->getMock();
	...
	{
		$presenter = $this->getMockBuilder('Illuminate\Pagination\BootstrapPresenter')->setMethods(array('getPageRange', 'getPrevious', 'getNext', 'getStart', 'getFinish'))->setConstructorArgs(array($paginator = $this->getPaginator()))->getMock();
	...
	{
		$presenter = $this->getMockBuilder('Illuminate\Pagination\BootstrapPresenter')->setMethods(array('getPageRange'))->setConstructorArgs(array($paginator = $this->getPaginator()))->getMock();
